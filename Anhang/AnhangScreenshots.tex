...
\begin{figure}[htb]
\centering
\includegraphicsKeepAspectRatio{screen_vmnetwork.png}{0.9}
...
\begin{figure}[htb]
\centering
\includegraphicsKeepAspectRatio{screen_vmcreation.png}{0.9}
...
\begin{figure}[!htb]
\centering
\includegraphicsKeepAspectRatio{screen_mysqlsecure.png}{0.9}
...
\begin{figure}[!htb]
\centering
\includegraphicsKeepAspectRatio{netzwerkplan.png}{0.9}
